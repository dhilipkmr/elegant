...
export default function GetQuote() {
	...
	function handleBtnClick() {
		...
		callAPI({ city: cityValue, name: nameValue, contact: contactValue, eventType: eventTypeValue, session: sessionValue, eventDate: eventDateValue });
	}
	...
	return (
		<div className="leading-loose m-4 p-10 bg-white md:text-xl md:px-32 rounded pb-20">
			...
			<form className="">
				<div className="flex flex-col md:flex-row">
					...
					<div className="w-full md:w-1/2 my-6">
						...
						<input ref={contact} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="cus_email" placeholder="Enter your Email ID"/>
					</div>
				</div>
				<div className="flex flex-row">
					<div className="w-1/2 pr-3 md:pr-12 my-6">
